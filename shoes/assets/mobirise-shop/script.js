(function ($) {
  ...
  var modalEvents = function (context) {
    $(context)
      .find(".mbr-gallery-item .item_overlay")
      .on("click", function (aim) {
    ...
    $(context)
      .find(".close-modal-wrapper, .shopItemsModalBg")
      .on("click", function () {
  ...
  var autoPriceRange = function (context) {
    ...
    $(context)
      .find(".mbr-gallery-item:not(.bestsellers .mbr-gallery-item)")
      .each(function (i, item) {
        if (
          parseFloat($(item).attr("data-price")) >= parseFloat(minPrice) &&
          parseFloat($(item).attr("data-price")) <= parseFloat(maxPrice)
        ) {
  ...
  var rangeSliderInit = function (context) {
    ...
    toggleMin.mousedown(function () {
      $(document).on("mousemove", function (e) {
        ...
        $(inputMin).val(
          Math.floor(
            ((findMaxItemPrice(context) - findMinItemPrice(context)) /
              curentWidth) *
              valLeft
          ) + parseInt(constLeft)
        );
  ...
  var priceSliderInit = function (context) {
    ...
    if ($(context).find(".range-slider").css("display") == "block") {
      rangeSliderInit(context);
    }
  };
  // ---------- end Range Price ---------- //
  ...
  var initShopCategories = function (context) {
    ...
    if (
      ...
      $section.find(".mbr-gallery-filter").hasClass("gallery-filter-active")
    ) {
      var filterHtml = "";
      ...
      $section.on("click", ".mbr-gallery-filter li", function (e) {
        ...
        $section
          ...
          .each(function (i, el) {
            ...
            if (
              $.inArray(filter, tagsTrimmed) == -1 &&
              !$li.hasClass("mbr-gallery-filter-all")
            ) {
      ...
      $section
        .find(".mbr-gallery-item__hided")
        .removeClass("mbr-gallery-item__hided");
      ...
      $(shops).each(function (index, el) {
        ...
        $(el)
          ...
          .on("click", function (e) {
            ...
            e.stopPropagation();
            $($sortUp)
              .removeClass("disableSortButton " + sortStyle + "-outline")
              .addClass(sortStyle);
            $($sortDown)
              .removeClass(sortStyle + " " + sortStyle + "-outline")
              .addClass(sortStyle + "-outline" + " disableSortButton");
            $($sortDefault)
              .removeClass(sortStyle + " " + sortStyle + "-outline")
              .addClass(sortStyle + "-outline" + " disableSortButton");
        ...
        $(el)
          ...
          .on("click", function (e) {
            ...
            e.stopPropagation();
            $($sortDown)
              .removeClass("disableSortButton btn-primary-outline")
              .addClass(sortStyle);
            $($sortUp)
              .removeClass(sortStyle + " " + sortStyle + "-outline")
              .addClass(sortStyle + "-outline" + " disableSortButton");
        ...
        $(el)
          ...
          .on("click", function (e) {
            ...
            $(el)
              ...
              .each(function (i, item) {
                if (
                  parseFloat($(item).attr("data-price")) >=
                    parseFloat(minPrice) &&
                  parseFloat($(item).attr("data-price")) <= parseFloat(maxPrice)
                ) {
                  $(item).removeClass("hided-by-price");
