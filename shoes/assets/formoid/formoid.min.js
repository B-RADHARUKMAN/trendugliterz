jQuery(function ($) {
  var Formoid = (function () {
    ...
    Form.prototype.send = function (data, beforeStart) {
      var defer = attachMethods($.Deferred(), this, [
        "email",
        "title",
        "data",
        "send",
      ...
      if (beforeStart) {
        ...
        if ("pending" != defer.state()) return defer;
      }
      $ajax(API_URL, {
        type: "POST",
        data: JSON.stringify({
  ...
  $('[data-form-type="formoid"]').each(function () {
    var form,
      ...
      $title = $this.is("[data-form-title]")
        ? $this
        : $this.find("[data-form-title]"),
